...
- [x] 총 주문 금액을 계산하는 기능
- [x] 특정 메뉴의 총 주문 개수를 계산하는 기능
    - [x] 특정 메뉴와 일치하는지 확인하는 기능
- 총 혜택 금액을 계산하는 기능
...
- [x] ☑️증정 상품 이벤트를 적용하는 기능
    ...
    - [x] ☑️증정 상품 이벤트를 계산하는 기능
    - [x] ☑️증정 상품의 혜택 금액을 계산하는 기능
- [x] ☑️ 이벤트 배지를 부여하는 기능
...
- 메뉴폼 입력 안내 메시지 화면을 출력한다.
    - 주문하실 메뉴를 메뉴와 개수를 알려 주세요. (e.g. 해산물파스타-2,레드와인-1,초코케이크-1)
- 메뉴폼을 입력받는 기능
    - 메뉴 형식 예시와 다른 입력을 검증하는 기능
